...
const RegisterPage = () => {
	...
	const validationSchema = yup.object().shape({
		...
		email: yup.string().email('Sai định dạng email!').required('Vui lòng nhập email!'),
	...
	return (
		<div className="bg-light d-flex justify-content-center py-5" style={{ minHeight: '100vh' }}>
			<div>
				<div
					...
					<div className="p-5">
						<form className="mt-5" onSubmit={handleSubmit(handleRegister)}>
							...
							<div className="d-grid mt-4">
								<Button type="submit">
									<i className="fas fa-fw fa-user-plus"></i>&nbsp;&nbsp;Đăng ký
								</Button>
							</div>
						</form>
					</div>
